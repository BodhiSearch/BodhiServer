// source: https://github.com/utilityai/llama-cpp-rs/blob/main/llama-cpp-sys-2/build.rs
use std::env;
use std::path::Path;
...
fn main() {
  ...
  for build in [&mut ggml, &mut llama_cpp] {
    ...
    } else if cfg!(target_arch = "aarch64") && (compiler.is_like_clang() || compiler.is_like_gnu())
    {
